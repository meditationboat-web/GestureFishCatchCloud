...
namespace Mediapipe.Unity.Sample
{
  ...
  public class AppSettings : ScriptableObject
  {
    ...
    [Header("Native Camera Fallback")]
    [Tooltip("Resolution used when WebCamTexture.devices is empty and the native Camera2 plugin takes over")]
    [SerializeField] private int _nativeCameraWidth = 1280;
    [SerializeField] private int _nativeCameraHeight = 720;
    [SerializeField] private double _nativeCameraFrameRate = 30.0;
